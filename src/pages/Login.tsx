...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-950 via-slate-950 to-slate-950 flex flex-col lg:flex-row relative overflow-hidden" style={{ zoom: '110%' }}>
      {/* Decorative Elements */}
